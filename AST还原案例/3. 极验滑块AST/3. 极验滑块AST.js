...
const jscode = fs.readFileSync('F:\\code\\ast_study\\AST还原案例\\3. 极验滑块AST\\极验滑块JS.js', {
    encoding: "utf-8"
});
    ...
    VariableDeclaration(path){
        ...
        if (declarations && declarations.length === 3){
            ...
            if (t.isMemberExpression(firstDeclaration.init) &&
                firstDeclaration.init.object.name === "AVczv" &&
...
// 提取 for switch 的主要逻辑 其中switch的case都是类似与AVczv.EIh()[3][7]这样
